...
public class AbnormalVitalJPanel extends javax.swing.JPanel {
    ...
    public AbnormalVitalJPanel(VitalSignHistory vsh, double DefaultMax,double DefaultMin) {
        initComponents();
        this.vsh = vsh;
        this.max = DefaultMax;
        this.min = DefaultMin;
        this.populateAbnormalTable();
    ...
    public void populateAbnormalTable()
     {
        DefaultTableModel dtm = (DefaultTableModel) abnormalTable.getModel();
        dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        abnormalTable = new javax.swing.JTable();
        ...
        abnormalTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane1.setViewportView(abnormalTable);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        int selectedRow = abnormalTable.getSelectedRow();
    ...
    private javax.swing.JTable abnormalTable;
