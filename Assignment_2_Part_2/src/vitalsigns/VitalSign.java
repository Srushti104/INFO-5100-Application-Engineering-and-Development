    ...
    private boolean isRespiratoryRateNormal() {
        ...
        if (age == 0) {
            if (respiratoryRate >= 30 && respiratoryRate <= 50) {
                System.out.println("Respiratory Rate was : " +  respiratoryRate);
                return true;
            } else {
                return false;
            }
    ...
    private boolean isHeartRateNormal() {
        ...
        if (age == 0) {
            if (heartRate >= 120 && heartRate <= 160) {
                System.out.println("Heart Rate was : " + heartRate);
                return true;
            }
            System.out.println("Heart Rate was : " + heartRate);
            return false;
    ...
    private boolean isBloodPressureNormal() {
        ...
        if (age == 0) {
            if (bloodPressure >= 50 && bloodPressure <= 70) {
                System.out.println("Systolic Blood Pressure was : " + bloodPressure);
                return true;
            }
            System.out.println("Systolic Blood Pressure was : " + bloodPressure);
            return false;
    ...
    private boolean isWeightInKgsNormal() {
        ...
        if (age == 0) {
            if (weightInKgs >= 2 && weightInKgs <= 3) {
                System.out.println("Weight in Kg was : " + weightInKgs);
                return true;
            }
            System.out.println("Weight in Kg was : " + weightInKgs);
            return false;
    ...
    private boolean isWeightInLbsNormal() {
        ...
        if (age == 0) {
            if (weightInPounds >= 4.5 && weightInPounds <= 7) {
                System.out.println("Weight in Pd was : " + weightInPounds);
                return true;
            }
            System.out.println("Weight in Pd was : " + weightInPounds);
            return false;
