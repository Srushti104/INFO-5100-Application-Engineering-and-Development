...
public class CreateProductJPanel extends javax.swing.JPanel {
    ...
    CreateProductJPanel(JPanel panel, ProductDirectory prodDir) {
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        boolean match = prodDir.searchName(productName);
        if (productName.length() <= 0 | price.length() <= 0 | availability.length() <= 0) {
